...
export const GoogleIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
        <path fill="#FFC107" d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039L38.804 12.803C34.553 8.818 29.625 6 24 6C12.955 6 4 14.955 4 26s8.955 20 20 20s20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z" />
        <path fill="#FF3D00" d="M6.306 14.691L12.741 19.32C14.655 13.438 18.921 9.479 24 9.479c3.059 0 5.842 1.154 7.961 3.039L38.804 5.604C34.553 1.618 29.625 0 24 0C16.517 0 9.882 3.566 6.306 14.691z" />
        <path fill="#4CAF50" d="M24 48c5.625 0 10.553-2.818 14.804-6.804l-6.438-4.636C29.842 41.846 27.059 44 24 44c-5.079 0-9.345-3.961-11.259-8.68L6.306 39.309C9.882 44.434 16.517 48 24 48z" />
        <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-0.792 2.237-2.231 4.166-4.087 5.571l6.438 4.636C42.418 34.818 44 30.553 44 26c0-1.341-.138-2.65-.389-3.917z" />
    </svg>
);
